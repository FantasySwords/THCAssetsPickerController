...
- (void)setAsset:(id)asset
{
    ...
    if ([asset isKindOfClass:[ALAsset class]]) {
        ...
        [manager requestImageForAsset:asset targetSize:CGSizeMake(self.frame.size.width * retinaScale, self.frame.size.height * retinaScale) contentMode:PHImageContentModeAspectFit options:requestOptions resultHandler:^(UIImage * _Nullable result, NSDictionary * _Nullable info) {
